...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #333333; padding-top: 20px;" class="padding-copy"><?= avb()->translation("label.form.auto_responder_message") ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <tr>
        <td bgcolor="#ffffff" align="center" style="padding: 15px;" class="padding">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px;" class="responsive-table">
                <?php
                $excludeFields = ['page_name', 'page_id', 'tour_name', 'tour_id'];
                ?>
                <?php foreach($values as $name => $value): ?>
                    <?php if(!in_array($name, $excludeFields)): ?>
